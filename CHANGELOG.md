...
- feat(transports): Category-based Rate Limiting ([#354](https://github.com/extrading/sentry-go/pull/354))
- feat(transports): Report User-Agent identifying SDK ([#357](https://github.com/extrading/sentry-go/pull/357))
- fix(scope): Include event processors in clone ([#349](https://github.com/extrading/sentry-go/pull/349))
- Improvements to `go doc` documentation ([#344](https://github.com/extrading/sentry-go/pull/344), [#350](https://github.com/extrading/sentry-go/pull/350), [#351](https://github.com/extrading/sentry-go/pull/351))
- Miscellaneous changes to our testing infrastructure with GitHub Actions
  ([57123a40](https://github.com/extrading/sentry-go/commit/57123a409be55f61b1d5a6da93c176c55a399ad0), [#128](https://github.com/extrading/sentry-go/pull/128), [#338](https://github.com/extrading/sentry-go/pull/338), [#345](https://github.com/extrading/sentry-go/pull/345), [#346](https://github.com/extrading/sentry-go/pull/346), [#352](https://github.com/extrading/sentry-go/pull/352), [#353](https://github.com/extrading/sentry-go/pull/353), [#355](https://github.com/extrading/sentry-go/pull/355))
...
The `sentryhttp` package got better API docs, an [updated usage example](https://github.com/extrading/sentry-go/tree/master/example/http) and support for creating automatic transactions as part of Performance Monitoring.
...
- **[breaking]** fix: Rename fasthttp integration package sentryhttp => sentryfasthttp
  ...
  import (
  	...
  	sentryfasthttp "github.com/extrading/sentry-go/fasthttp"
